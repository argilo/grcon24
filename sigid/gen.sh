...
pid=$!
sleep 5
echo pocsag1200 0 931862500 alpha 31337 `echo "flag{74d74b540b070f16ed30c607bfbe0905}" | xxd -ps -c 200` | nc -q 1 localhost 52001
kill $pid
...
pid=$!
sleep 5
echo flex 0 931862500 alpha 424242 `echo "flag{0511696e30d8a1b3329db1bc8e5057e5}" | xxd -ps -c 200` | nc -q 1 localhost 52001
kill $pid
